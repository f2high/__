from src.main.utils import parse_batch_response, make_http_socket, shutdown_socket
    ...
    while gid_list_len >= gid_chunk_size:
        ...
        while True:
            ...
            try:
                ...
                # print("gid chunk from", gid_chunk[0].decode(), "to", gid_chunk[-1].decode())
                sock.send(
               ...
               # print("all data received")
                ...
                for gid in gid_chunk:
                    ...
                    #print('v1: Parsed Data Successfully')
                    #not group_info["publicEntryAllowed"]
                      #  or group_info["owner"]
                       # or "isLocked" in group_info

                    if (group_info["publicEntryAllowed"] == False) or ("isLocked" in group_info) or (group_info["owner"] is not None):
